...
<body style="background-image: url('<?= URL ?>/public/Assets/images/backgroundimage.jpg')">
    <img src="<?= URL ?>/public/Assets/images/allmovies.png" width="200px" alt="logo">
        <div class="container">
            ...
            <section>
                <div id="login-body">
                    <h1>Modifier Mot de passe Admin</h1>
                    ...
                    <div id="suppressionCompte" class="cacher-element">
                        <div class="alert-danger">
                            ...
                            <br>
                            <a href="<?= URL ?>compte/suppressionCompte_administrateur" class="alert-danger">je souhaite supprimer mon compte définitivement Cliquer : ici</a>
                        </div>
                    </div>
                </div>
            </section>
